...
<div class="wrapper">
	...
	<!-- Form -->
	<form class="form" id="form" action="<?php echo admin_url('product/add')?>" method="post"
		...
		<fieldset>
			<div class="widget">
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="sale" id="param_sale"
				...
				<div class="formSubmit">
					<input type="submit" value="Thêm mới" class="redB"> <input
