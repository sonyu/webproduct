...
<div class="box-left">
	...
	<div class="content-box">
		<!-- The content-box -->
		<form class="t-form form_action" method="get" style="padding: 10px"
			...
			<div class="form-row">
				...
				<div class="form-item">
					<input class="button" name="search" value="Tìm kiếm"
	...
	<div class="content-box">
		...
		<ul class="catalog-main">
	          <?php foreach ($catalog_list as $row):?>
                           <li><span><a
					href="<?php echo base_url('product/catalog/'.$row->id)?>"
				...
				<ul class="catalog-sub">
			             	 	 <?php foreach ($row->subs as $subs):?> 
			                            <li><a
						href="<?php echo base_url('product/catalog/'.$subs->id)?>"
