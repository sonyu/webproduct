...
<div class="top">
	...
	<div id="logo">
		<!-- the logo -->
		<a title="Học lập trình website với PHP và MYSQL"
			href="<?php echo base_url()?>"> <img
			alt="Học lập trình website với PHP và MYSQL"
			src="<?php echo public_url()?>/site/images/logo.jpg">
		</a>
	</div>
	<!-- End logo -->
	...
	<div class="cart" id="cart_expand">
		<a class="cart_link" href="<?php echo base_url('cart')?>"> Giỏ hàng <span
			id="in_cart"><?php echo $total_items?></span> sản phẩm
		</a> <img src="<?php echo public_url()?>/site/images/cart.png"
			alt="cart bnc">
	</div>
	<div id="search">
		<!-- the search -->
		<form action="<?php echo site_url('product/search')?>" method="get">
			<input type="text" aria-haspopup="true" aria-autocomplete="list"
				...
				placeholder="Tìm kiếm sản phẩm..." value="<?php echo isset($key) ? $key :''?>" name="key-search"
